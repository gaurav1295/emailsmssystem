...
<div id="cl-wrapper" class="login-container">
    ...
    <div class="middle-login">
        <div class="block-flat">
            <div class="header">
                <h3 class="text-center"><img class="logo-img" src="<?php echo appconfig('logo'); ?>" width="100px" height="45px" alt="logo"/></h3>
            </div>
            <div>
                <?php notify(); ?>

                <form style="margin-bottom: 0px !important;" class="form-horizontal" action="<?php echo $self; ?>" method="post">
                    <div class="content">
