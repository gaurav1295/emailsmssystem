<?php
 $xheader='
      <link src="views/besma/assets/js/introjs/themes/introjs-dark.css" rel="stylesheet"></link>
    <link src="views/besma/assets/js/introjs/minified/introjs.min.css" rel="stylesheet"></link>
 ';
 $xfooter='
     <script src="views/besma/assets/js/introjs/minified/intro.min.js" type="text/javascript" ></script>
